...
type Section = "about" | "experience" | "projects" | "recommendations";
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-16 lg:flex lg:gap-4">
        ...
        <header className="lg:sticky lg:top-0 lg:h-screen lg:w-[45%] lg:flex lg:flex-col lg:justify-between py-16 lg:py-24 shrink-0">
          ...
          <div className="flex items-center gap-5 mt-10 lg:mt-0">
            {[
              { icon: <LinkedinIcon />, href: "https://www.linkedin.com/in/rickmagarro/", label: "LinkedIn" },
            ].map(({ icon, href, label }) => (
              <a
                key={label}
                href={href}
        ...
        <main className="lg:w-[55%] py-16 lg:py-24 space-y-28">
          ...
          >
            ...
            <div className="space-y-4 text-sm leading-relaxed">
              <p>
                I'm a tech leader and a Senior Systems Engineer with over 15 years of hands-on experience building secure,
                scalable IT systems. My philosophy is simple: take complex infrastructure challenges and turn them into{" "}
                <span style={{ color: "#ccd6f6" }}>automated, repeatable solutions</span> that work for teams. I've led global teams and spent most of my career focused on{" "}
                <span style={{ color: "#ccd6f6" }}>identity and access management</span>—helping organizations
                with 5,000+ employees navigate compliance with GDPR, ISO 27001, and SOC 2.
              </p>
              <p>
                I work directly with platforms like{" "}
                <span style={{ color: "#ccd6f6" }}>Okta, Entra ID, JumpCloud, Jamf, and Microsoft Intune</span>,
                and I design Slack bot workflows to automate tedious IT operations. At the end of the day,
                I'm driven by solving hard problems and building systems that are simple and reliable.
              </p>
            </div>
